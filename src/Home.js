...
//         "https://cdn.jsdelivr.net/npm/rhino3dm/"
//       );
//     }
//   );
...
export function RhinoModel2(props) {
  console.log("test");
  const modelSource = useLoader(Rhino3dmLoader, "/test2.3dm", (loader) => {
  ...
  return <primitive object={modelSource} ref={ref} dispose={null} />;
}
